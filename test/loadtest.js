...
describe('Performance Test', function () {
  ...
  it('performance testing /b83SzspsU7ki', function (done) {
    this.timeout(1000 * 60);

    var options = {
      url: host + '/b83SzspsU7ki',
      maxSeconds: 30,
      concurrency: 25,
  ...
  it('performance testing /link?code=b83SzspsU7ki', function (done) {
    this.timeout(1000 * 60);

    var options = {
      url: host + '/link?code=b83SzspsU7ki',
      maxSeconds: 30,
      concurrency: 25,
      statusCallback: statusCallback,
    };
